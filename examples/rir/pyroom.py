...
print(f"pyroomacoustics: {np.mean(py_times)} +/- {np.std(py_times)} s")
# print(f"timerir: {np.mean(tr_times)} +/- {np.std(tr_times)} s")
print(f"freqrir: {np.mean(fr_times)} +/- {np.std(fr_times)} s")
